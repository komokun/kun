defmodule KunWeb.Presence do
  ...
  Presences can be tracked in your channel after joining:
      defmodule Prater.MyChannel do
        use KunserverWeb, :channel
        alias Kunserver.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :kun,
                        pubsub_server: Kun.PubSub
end
